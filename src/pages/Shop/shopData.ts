...
export const SHOP_SUMMARY: ShopSummary = {
  ...
  items: [
    ...
    },
    {
      ...
      type: "BACKGROUND",
      price: 120,
      thumbnail_url: "/shop/bg-neon.png",
      asset_url: "/shop/bg-neon.png",
      is_owned: false,
      is_equipped: false,
      sound_files: [],
    },
    {
      ...
      type: "BACKGROUND",
      price: 90,
      thumbnail_url: "/shop/bg-wood.png",
      asset_url: "/shop/bg-wood.png",
      is_owned: true,
      is_equipped: false,
      sound_files: [],
    },
    {
      ...
      type: "BACKGROUND",
      price: 100,
      thumbnail_url: "/shop/bg-dark.png",
      asset_url: "/shop/bg-dark.png",
      is_owned: true,
      is_equipped: true,
      sound_files: [],
    },
    {
      ...
      type: "BACKGROUND",
      price: 150,
      thumbnail_url: "/shop/bg-pastel.png",
      asset_url: "/shop/bg-pastel.png",
      is_owned: false,
      is_equipped: false,
      sound_files: [],
    },
    ...
    },
    {
      ...
      type: "DECORATION",
      price: 70,
      thumbnail_url: "/shop/deco-plant.png",
      asset_url: "/shop/deco-plant.png",
      is_owned: false,
      is_equipped: false,
      sound_files: [],
    },
    {
      ...
      type: "DECORATION",
      price: 70,
      thumbnail_url: "/shop/deco-stars.png",
      asset_url: "/shop/deco-stars.png",
      is_owned: true,
      is_equipped: false,
      sound_files: [],
    },
